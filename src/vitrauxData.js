...
export const vitrauxData = [
    ...
    { url: '2', texture1: thrash, texture2: thrashLegendes, type: 'triple', idd: 2, length: 8, genre: 'Hardcore', music: HornetsNest, musicTitle: "Power Trip - Hornet's Nest" },
    ...
    { url: '6', texture1: thrash, texture2: thrashLegendes, type: 'triple', idd: 6, length: 8, genre: 'Trash Metal', music: FreezingMoon, musicTitle: "Mayhem - Freezing Moon" },
    ...
    { url: '10', texture1: thrash, texture2: thrashLegendes, type: 'triple', idd: 10, length: 8, genre: 'Death Metal', music: SpiritCrusher, musicTitle: "Death - Spirit Crusher" },
    ...
    { url: '14', texture1: thrash, texture2: thrashLegendes, type: 'triple', idd: 14, genre: 'Death Metal', music: SpiritCrusher, musicTitle: "Death - Spirit Crusher" },
]