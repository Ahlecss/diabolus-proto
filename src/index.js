...
const vitraux = [
  // Front
  { position: [0, 0, 1.5 * -4], rotation: [0, 0, 0], url: '0', texture: black, idd: 0, genre: 'Black Metal', music: FreezingMoon },
  { position: [0, 0, 1.51 * -4], rotation: [0, 0, 0], url: '1', texture: blackLegendes, idd: 1 },
  // Left
  { position: [-9, 0, -3.75], rotation: [0, Math.PI / 2.5, 0], url: '2', texture: hardcore, idd: 2, genre: 'Harcore', music: HornetsNest },
  { position: [-9.01, 0.01, -3.76], rotation: [0, Math.PI / 2.5, 0], url: '3', texture: hardcoreLegendes, idd: 3 },
  // Right
  { position: [9, 0, -3.75], rotation: [0, -Math.PI / 2.5, 0], url: '4', texture: death, idd: 4, genre: 'Death Metal', music: SpiritCrusher },
